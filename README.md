...
In the project directories client and server (2 consoles), to run the app u need to input command:
### `npm start`
...
/server directory:
Runs the local server on your computer on localhost:3001 

More client development side commands: 
