const ACTION_TYPES = {
  ...
  SET_GAME_BOARD_CELLS_REQUEST: 'SET_GAME_BOARD_CELLS_REQUEST',
  SET_GAME_BOARD_CELLS_SUCCESS: 'SET_GAME_BOARD_CELLS_SUCCESS',
  SET_GAME_BOARD_CELLS_ERROR: 'SET_GAME_BOARD_CELLS_ERROR',
};
